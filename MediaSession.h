...
// MediaKeySession overrides
    ...
    virtual CDMi_RESULT DecryptNetflix(const unsigned char* IVData, uint32_t IVDataSize, unsigned long long byteOffset, unsigned char data[], uint32_t size, bool initWithLast15) override;
